...
**Live:** [https://relaxed-weasel-papermark.cloud.nexlayer.ai](https://relaxed-weasel-papermark.cloud.nexlayer.ai)  
...
**papermark** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/mfts/papermark:latest
    path: /
    servicePorts:
    - 3000
    vars:
      DATABASE_URL: "postgresql://papermark:${POSTGRES_PASSWORD}@postgres.pod:5432/papermark"
